...
class GatewayRoutingTest {
  ...
  private static final int GATEWAY_PORT = 29875;
  ...
  @Test
  void routesToInventoryService() throws Exception {
    assertRoute("inventory-service");
  }

  @Test
  void routesToCartService() throws Exception {
    assertRoute("cart-service");
  }

  @Test
  void routesToCatalogService() throws Exception {
    assertRoute("catalog-service");
  }

  @Test
  void routesToOrderService() throws Exception {
    assertRoute("order-service");
  }
